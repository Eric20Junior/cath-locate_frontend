                ...
                {churches?.map((church) => (
                  <tr key={church.id}>
                    ...
                    <td class="border border-gray-300 px-4 lg:space-x-4 xs:space-y-3 xs:text-center py-2">
                      <Link to={`/dashboard/detailpage/${church.id}`} className='xs:border xs:border-[#048950] xs:px-4 xs:py-2 xs:w-16 xs:rounded-md xs:text-xs'>View</Link>
                      <Link to={`/dashboard/delete/${church.id}`} className='xs:border xs:border-red-500 xs:px-4 xs:py-2 xs:w-16 xs:rounded-md xs:text-xs'>Delete</Link>
                    </td>
                  </tr>
                  ))}
                </tbody>
