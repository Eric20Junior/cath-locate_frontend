                ...
                {faqs?.map((faq) => (
                  <tr key={faq.id}>
                    ...
                    <td class="border border-gray-300 px-4 lg:space-x-4 xs:space-y-3 xs:text-center py-2">
                      <Link to={`/admin/update/${faq.id}`} className='xs:border xs:border-[#048950] xs:px-4 xs:py-2 xs:w-16 xs:rounded-md xs:text-xs'>Update</Link>
                      <Link to={`/admin/delete/`} className='xs:border xs:border-red-500 xs:px-4 xs:py-2 xs:w-16 xs:rounded-md xs:text-xs'>Delete</Link>
                    </td>
                  </tr>
                ))}
                </tbody>
